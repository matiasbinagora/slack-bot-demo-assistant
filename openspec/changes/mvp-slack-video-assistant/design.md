...
La representación de frames en esa frontera seguirá siendo controlada y local: el pipeline entregará imágenes seleccionadas como payloads serializados del request de análisis, nunca como rutas locales ni URLs privadas de Slack.
